...
const RequestTablePart = ({ applications, onView, onReply }) => {
  const partApps = applications.filter(app => app.type === "part");

  if (!partApps.length) {
    return <p className="text-gray-600">Нет заявок на запчасти.</p>;
  }
...
export default RequestTablePart;
